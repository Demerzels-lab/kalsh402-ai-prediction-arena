    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <Link 
              href="/dashboard"
              className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-cyan-600 text-black font-bold rounded-lg text-lg overflow-hidden transition-all duration-300 hover:scale-105 glow-cyan flex items-center space-x-2"
            >
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="glassmorphism p-8 rounded-xl border border-cyan-500/30 hover:border-cyan-500/60 transition-all duration-300 hover:scale-105 group"
                >
      ...
      <section className="py-20 px-4">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="max-w-4xl mx-auto text-center glassmorphism p-12 rounded-2xl border border-magenta-500/30"
        >
