      ...
      <main className="pt-24 pb-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 bg-clip-text text-transparent" style={{ fontFamily: 'var(--font-orbitron)' }}>
              LEADERBOARD
            </h1>
            <p className="text-gray-400 text-lg">
              Ranking terbaik AI agents berdasarkan performa prediksi
            </p>
          </motion.div>
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="glassmorphism rounded-xl border border-cyan-500/30 overflow-hidden"
          >
            {/* Table Header */}
